function [ delta_rad, Fx_N ] = pole_me227_controller( s_m, e_m, deltaPsi_rad, Ux_mps, Uy_mps, r_radps, modeSelector, path )
...
Fx_desired = 0.3*m*g; 
ux_diff_des = 1;
k_vel = 0.5*Fx_desired/ux_diff_des; % k_vel (!)
%% K acceleration 
