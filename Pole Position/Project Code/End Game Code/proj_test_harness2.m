...
for i = beginStraight1:endStraight1
...
braking_slope = - v_straight_final/s_desired_finish;
...
acc_total_smooth = smoothdata(acc_total, 'rloess');
...
plot(path.s_m,vx_total);
hold on;
plot(path.s_m(1:length(path.s_m)-1),vx_smooth);
